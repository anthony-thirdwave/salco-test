...
insert t_label ( LabelID,LabelCode,LabelName,LabelGroupID,LabelPriority,LabelImage,LabelParent )  select 254,'CONTTYP','Blog Entry Listing',70,290,'/common/images/ContentManager/icon_teaser.gif',0
insert t_label ( LabelID,LabelCode,LabelName,LabelGroupID,LabelPriority,LabelImage,LabelParent )  select 255,'CONTTYP','Blog Navigation',70,300,'/common/images/ContentManager/icon_teaser.gif',0
