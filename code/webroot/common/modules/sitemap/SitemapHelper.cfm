...
<cfif getdetail.CategoryActiveDerived IS "1" >
	<cfoutput>
		<cfif Trim(getdetail.CategoryURLDerived) iS NOT "">
			<li><a href="#APPLICATION.utilsObj.parseCategoryUrl(GetDetail.CategoryURL)#">#getdetail.CategoryNameDerived#</a></li>
		<cfelse>
			<li><a href="#APPLICATION.utilsObj.parseCategoryUrl(GetDetail.CategoryAlias)#">#getdetail.CategoryNameDerived#</a></li>
		</cfif>
	</cfoutput>
</cfif>
