...
<cfif GetCategoryList.RecordCount GT "0">
	...
	<cfoutput query="GetCategoryList">
		<cfquery name="LOCAL.GetChildren" dbtype="query">
			select * from GetChildrenPrime where ParentID=<cfqueryparam value="#GetCategoryList.CategoryID#" cfsqltype="cf_sql_integer">
		</cfquery>
		<cfset ThisUrl="" />
		...
		<li><a href="#ThisURL#" data-CategoryID="#GetCategoryList.CategoryID#" <cfif LOCAL.GetChildren.RecordCount GT "0">data-HasChildren="true"<cfelse>data-HasChildren="false"</cfif>>#GetCategoryList.CategoryNameDerived#</a></li>
	</cfoutput>
	</ul>
</cfif>
