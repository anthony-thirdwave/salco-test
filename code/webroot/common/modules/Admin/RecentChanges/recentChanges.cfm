...
<cfif isDefined("GetLastUpdated") and GetLastUpdated.RecordCount GT "0">
	...
	<cfoutput query="GetLastUpdated" maxrows="10">
		<tr valign="top">
			...
			<cfelse>
				<a href="#APPLICATION.contentPageInUrl#/#CategoryAlias#" target="_blank"><img src="/common/images/admin/icon_preview.gif" border="0" title="Preview Page in new Tab"/></a>&nbsp;
				<a href="/common/admin/Masterview/index.cfm?MVEid=1&mvcid=#KeyID#"><img src="/common/images/admin/icon_magnify.gif" title="Go to content in Masterview" border="0"/></a>&nbsp;
