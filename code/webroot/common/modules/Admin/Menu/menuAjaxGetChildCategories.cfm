<cfsetting showdebugoutput="1"><cfif NOT IsDefined("SESSION.adminuserpassword") OR (IsDefined("SESSION.adminuserpassword") AND SESSION.adminuserpassword EQ "")>session timeout<cfelse>
<cfsilent>
