			...
			<TD colspan="2">
				...
				<cfloop index="fi" from="#ArrayLen(aFile)#" to="1" step="-1">
					...
					<cfif FormMode IS "ShowForm">
						<cfoutput>
							...
							<TD><strong>#fi#)</strong></TD>
							<TD nowrap>
								<input type="text" name="FileName_#fi#" value="#aFile[fi].FileName#" size="40" maxlength="128">
								<!--- <textarea cols="40" rows="4" name="FileName_#fi#">#aFile[fi].FileName#</textarea><br> --->
							</TD>
							<TD>
								...
								<cfif 0>
									<input type="text" size="40" name="MainFilePath_#fi#" value="#aFile[fi].FilePath#">
								<cfelse>
									<input type="file" name="MainFilePath_#fi#FileObject" value="#aFile[fi].FilePath#" size="40">
								</cfif>
								<input type="hidden" name="MainFilePath_#fi#" value="#aFile[fi].FilePath#">
								<!--- <small>Description</small><br> --->
								<!--- <textarea cols="40" rows="4"  name="FileCaption_#fi#">#aFile[fi].FileCaption#</textarea><br> --->
				...
				<cfif FormMode IS "ShowForm">
					<tr valign="top">
						<TD></TD>
						<TD>
							<small>Title ( * required )</small><br>
							<input type="text" name="FileName_New" value="" size="40" maxlength="128">
							<!--- <textarea cols="40" rows="3" name="FileName_New"></textarea><br> --->
						</TD>
						<TD>
							Main: <br>
