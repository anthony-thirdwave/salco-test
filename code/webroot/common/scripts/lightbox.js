...
(function($) {
	...
	$.fn.lightBox = function(settings) {
		...
		settings = jQuery.extend({
			...
			imageLoading:			'/common/images/template/loading.gif',		// (string) Path and the name of the loading icon
			imageBtnPrev:			'/common/images/template/lightboxPrev.png',			// (string) Path and the name of the prev button image
			imageBtnNext:			'/common/images/template/lightboxNext.png',			// (string) Path and the name of the next button image
			imageBtnClose:			'/common/images/template/closeLightbox.png',		// (string) Path and the name of the close btn
			// Configuration related to container image box
			containerBorderSize:	14,			// (integer) If you adjust the padding in the CSS for the container, #lightbox-container-image-box, you will need to update this value
		...
		function _resize_container_image_box(intImageWidth,intImageHeight) {
			...
			$('#lightbox-container-image-box').animate({ width: intImageWidth, height: intImageHeight },settings.containerResizeSpeed,function() { _show_image(); });
		...
		function _show_image_data() {
			...
			if ( settings.imageArray.length > 1 ) {
				$('#lightbox-image-details-currentNumber').html(( settings.activeImage + 1 ) + '/' + settings.imageArray.length).show();
			}		
		}
		/**
