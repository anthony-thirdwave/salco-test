...
function SetLinkType( linkType )
{
	...
	ShowE('divLinkTypeIntUrl'		, (linkType == 'inturl') ) ;
	ShowE('divLinkTypeResource'		, (linkType == 'resource') ) ;
	...
	if ( !FCKConfig.LinkDlgHideAdvanced )
		window.parent.SetTabVisibility( 'Advanced'	, (linkType != 'anchor' && linkType != 'inturl' && linkType != 'resource' || bHasAnchors) ) ;
...
function Ok()
{
	...
	switch ( GetE('cmbLinkType').value )
	{
		...
		case 'resource' :
			...
			// Since it's a resource, file.cfm will look it up -dk
			sUri = "/file.cfm?fid=" + sUri;
