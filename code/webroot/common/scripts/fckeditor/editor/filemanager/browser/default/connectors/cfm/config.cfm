...
<cfscript>
	...
	//config.userFilesPath = "/incoming/";
	//config.userFilesPath = ATTRIBUTES.userdir;
	config.userFilesPath = URL.userdir;
	config.serverPath = "#getBaseTemplatePath()#" // TPS
	...
	config.allowedExtensions["File"] = "jpeg,jpg,gif,pdf,png";
	...
	config.allowedExtensions["Media"] = "jpg,gif,jpeg,png,bmp";
