...
<cfoutput>
<p style="border:1px red solid; padding:5px;">This is NOT the staging server. The staging server can be accessed at <a href="#APPLICATION.StagingURL#">#APPLICATION.StagingURL#</a>.</p>
</cfoutput>
</cfif>
