	...
	<cfoutput query="GetWF" group="WorkflowRequestID">
		...
		<td>#FromFirstName# #FromMiddleName# #FromLastName#
			<cfif FromEmailAddress IS NOT "">
				<a href="mailto:#FromEmailAddress#?subject=#WorkflowRequestTypeName#: #CategoryName#&body=%0A%0A%0A%0A%0A%0A%0APage: #CategoryName#%0AView: http://#REQUEST.CGIHTTPHost##APPLICATION.utilsObj.parseCategoryUrl(CategoryAlias)#%0AEdit: http://#REQUEST.CGIHTTPHost##EditPage#?#QueryString#" Title="Email"><img src="/common/images/admin/icon_email.gif" border="0"/></A>
			</cfif>
			</td>
		<TD>
