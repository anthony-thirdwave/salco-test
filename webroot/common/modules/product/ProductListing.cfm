			...
			<cfif qGetProductList.RecordCount GT "0">
				...
				<cfoutput query="qGetProductList">
					...
					<tr>
						...
						<cfif qGetProductList.PublicDrawing IS NOT "" and FileExists(ExpandPath(qGetProductList.PublicDrawing))><a href="#qGetProductList.PublicDrawing#" target="_blank">CAD Drawing</a><cfelse>&nbsp;</cfif>
						</td>
					</tr>
				</cfoutput></tbody>
				</table>
