...
<tr valign="top"> 
	<TD bgcolor="white"></TD><TD nowrap bgcolor="white" class="allcaps">
		...
		<cfif FormMode EQ "ShowForm">
			<div id="pageChooser" style="display:none; border:1px solid black; width:400px; background-color:#FFFFCC; position:absolute; margin:16px 0px 0px -120px; z-index:1;/*overflow: inherit;*/ white-space:normal;">
