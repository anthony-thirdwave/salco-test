...
<!-- begin cf_activedit v:4.0 (4.0.0.51 04/27/2004)  --></cfoutput>
...
<!--- 	CF_Activedit 
		...
		Authors: 	Pete Freitag
					Matt Finn 
					Greg Alton
		Version: 4.0 (4.0.0.51 04/27/2004)
...
<cfset ae_stockbtns.clean="6017,Clean,'Removes style code. H. span. and font tags. Microsoft classes and xml code.',images/broom.gif">
...
<!--- define parameters --->			
			...
			<cfparam name="attributes.clean" default="1" type="boolean">
		...
		<cfif NOT IsDefined("attributes.toolbar")>
			...
			<cfif attributes.clean><cfset toolbar=toolbar&",clean"></cfif>
...
<!--- check applet/dhtml mode --->
			...
			<cfif cgi.http_user_agent DOES NOT CONTAIN "MSIE" OR LCase(cgi.http_user_agent) does not contain "windows">
				...
				<cfif LCase(cgi.http_user_agent) contains "mac">
					<cfset applet = false>
					<cfif cgi.http_user_agent contains "Safari">
						<cfset applet = true>
						<cfif cgi.http_user_agent contains "Safari/10"><cfset applet=false></cfif>
						<cfif cgi.http_user_agent contains "Safari/85"><cfset applet=false></cfif>
					</cfif>
				</cfif>
...
<cfelseif applet>
	...
	<cfelse>
		...
		document.write("<param name=\"base_url\" value=\"#attributes.baseurl#\">");
		...
		document.write("<param name=\"quickfonts\" value=\"#attributes.quickfonts#\">");
...
<!-- end cf_activedit v:4.0 (4.0.0.51 04/27/2004) -->
