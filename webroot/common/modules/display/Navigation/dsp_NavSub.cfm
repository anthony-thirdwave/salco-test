...
<cfparam name="ATTRIBUTES.CSSID" default="subnav">
<cfparam name="ATTRIBUTES.CSSClass" default="nav">
...
<CFSET ExecuteTempFile="#APPLICATION.LocaleID#\+subNav_#ATTRIBUTES.ParentID#_#APPLICATION.LocaleID#_#DateFormat(GetLastCache.CacheDateTime,'yyyymmdd')##TimeFormat(GetLastCache.CacheDateTime,'HHmmss')#.cfm">
